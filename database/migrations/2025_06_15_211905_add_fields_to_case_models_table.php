...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('case_models', function (Blueprint $table) {
            $table->string('departamento')->nullable()->after('description');
            $table->string('despacho')->nullable()->after('departamento');
            ...
            $table->unsignedBigInteger('id_proceso')->nullable()->after('id_conexion');
            $table->string('llave_proceso')->nullable()->after('id_proceso');
            $table->text('sujetos_procesales')->nullable()->after('llave_proceso');
        });
    }
